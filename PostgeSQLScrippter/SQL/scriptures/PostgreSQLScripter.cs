...
namespace SqlScrippter.SQL.scriptures
{
    internal class PostgreSQLScripter:SQLScripture
    {
        ...
        /// <returns></returns>
        public string uniqueKey(in List<LibraryOFStructs.Types> unqiueKey, bool keyIsConstraint, string tableName, bool script)
        {
        ...
        public bool check_the_key(string tableName)
        {
            return true;
        }
    }
